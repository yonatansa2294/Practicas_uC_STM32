...
#define TICK_PIN 							GPIO_PIN_5
#define TICK_GPIO_PORT 						GPIOB
#define TICK_GPIO_CLK_ENABLE()				__HAL_RCC_GPIOB_CLK_ENABLE();
#define TICK_GPIO_CLK_DISABLE()				__HAL_RCC_GPIOB_CLK_DISABLE();
